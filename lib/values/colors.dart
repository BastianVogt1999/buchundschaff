...
class WhiteMode {
  Color backgroundColor = const Color.fromARGB(255, 245, 248, 227);
  Color cardColor = const Color.fromARGB(255, 173, 173, 173);
  Color textColor = const Color(0xff2f2f2f);
  Color abstractColor = const Color.fromARGB(255, 107, 109, 108);
  Color redLight = const Color.fromARGB(255, 244, 199, 198);
}

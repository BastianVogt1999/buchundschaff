...
class DeleteStatements {
  deleteStatistic(Company company, User user, Statistic statistic) async {
    List<String> allUserInStat = await selectStatements.selectUserOfStat(statistic.statistic_id, company);
    
    var database = FirebaseFirestore.instance.collection(
        '/AllProjects/' + company.company_name + '/StatisticsInProject' + statistic.statistic_id + "User");
